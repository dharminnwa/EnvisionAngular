...
var MapLibraryComponent = (function () {
    function MapLibraryComponent(activeModal, utilityService) {
        this.activeModal = activeModal;
        this.utilityService = utilityService;
    }
    MapLibraryComponent.prototype.ngOnInit = function () {
        this.utilityService.CloseModalOnRouteChange(this.activeModal);
    };
    MapLibraryComponent = __decorate([
        core_1.Component({
...
//# sourceMappingURL=map-library.component.js.map