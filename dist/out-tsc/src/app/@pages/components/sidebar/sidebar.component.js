...
var SidebarComponent = (function () {
    ...
    SidebarComponent.prototype.SetBottomGridWidth = function () {
    ...
    __decorate([
        core_1.ContentChild('sideBarOverlay'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "sideBarOverlay", void 0);
    __decorate([
        core_1.ContentChild('sideBarHeader'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "sideBarHeader", void 0);
    __decorate([
        core_1.ContentChild('menuItems'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "menuItems", void 0);
    __decorate([
        core_1.ContentChild('sideBarFooter'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "sideBarFooter", void 0);
    __decorate([
        core_1.ContentChild('privateMenuItems'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "privateMenuItems", void 0);
    __decorate([
        core_1.ContentChild('sharedMenuItems'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "sharedMenuItems", void 0);
    __decorate([
        core_1.ContentChild('temporaryLayerItems'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "temporaryLayerItems", void 0);
    __decorate([
        core_1.ContentChild('drawToolItems'),
        __metadata("design:type", core_1.TemplateRef)
    ], SidebarComponent.prototype, "drawToolItems", void 0);
    __decorate([
