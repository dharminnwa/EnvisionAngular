...
var pgUploadComponent = (function () {
    ...
    function pgUploadComponent(cd) {
        ...
        this.onRemove = function (file) {
            ...
            file.status = 'removed';
            (_this.Remove ? _this.Remove instanceof Observable_1.Observable ? _this.Remove : of_1.of(_this.Remove(file)) : of_1.of(true))
                .pipe(filter_1.filter(function (res) { return res; }))
