...
var pgTabSetComponent = (function () {
    ...
    Object.defineProperty(pgTabSetComponent.prototype, "SelectedIndexChange", {
        get: function () {
            return this.SelectChange.pipe(map_1.map(function (event) { return event.index; }));
        },
        enumerable: true,
        configurable: true
    });
