...
var pgTabsNavComponent = (function () {
    ...
    pgTabsNavComponent.prototype.ngAfterContentInit = function () {
        ...
        this._realignInkBar = this._ngZone.runOutsideAngular(function () {
            var dirChange = _this._dir ? _this._dir.change : of_1.of(null);
            var resize = typeof window !== 'undefined' ?
                fromEvent_1.fromEvent(window, 'resize').pipe(auditTime_1.auditTime(10)) :
                of_1.of(null);
            return merge_1.merge(dirChange, resize).pipe(startWith_1.startWith(null)).subscribe(function () {
    ...
    __decorate([
        core_1.ContentChild('tabBarExtraContent'),
    ...
    __decorate([
        core_1.ViewChild(tabs_ink_bar_directive_1.pgTabsInkBarDirective),
