...
var pgCollapseComponent = (function () {
        ...
        core_1.Component({
            ...
            animations: [
                animations_1.trigger('collapseState', [
                    ...
                    animations_1.transition('inactive => active', animations_1.animate('0.2s ease-in')),
                    animations_1.transition('active => inactive', animations_1.animate('0.2s ease-out'))
                ])
            ],
            host: {
                '[class.card]': 'true',
                '[class.card-transparent]': 'true',
                '[class.m-b-0]': 'true',
            }
        }),
